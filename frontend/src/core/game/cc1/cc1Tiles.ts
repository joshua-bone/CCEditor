// frontend/src/core/game/cc1/cc1Tiles.ts

export const CC1TileId = {
  FLOOR: 0,
  WALL: 1,
  CHIP: 2,
  WATER: 3,
...
// Numeric tile ID type: 0 | 1 | 2 | ... | 111
export type CC1TileId = (typeof CC1TileId)[keyof typeof CC1TileId];
